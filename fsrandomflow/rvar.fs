...
//Generating a ziggarut table is non-trivial. None of this below is correct.
...
//        |> Array.rev
//        |> Array.map(fun (y,x) -> (x,standardNormalPdf(0.0)-y))
//    //Marsaglia & Tang, "The Ziggarut Method for Generating Random Variables", section 3
//    let normalZiggarutSteps = 
//        let r = 3.6541528853610088
//        let v = 0.00492867323399
//        let f = standardNormalPdf
//        let g = standardNormalInversePdf
//        seq {
//            yield! Seq.unfold(fun (rem, xprev) -> if rem < 1 then None else Some (xprev, (rem-1,g(v/xprev + f(xprev))))) (254,r)
//            yield 0.0
//        } |> Seq.map(fun x -> (x,f(x))) |> Seq.toArray
//
//    
//      [|
//        (0.0000000,0.3989423);(0.07841241,0.39771771);(0.1573107,0.3940365);(0.2372021,0.3878755)
//        ;(0.3186394,0.3791952);(0.4022501,0.3679379);(0.4887764,0.3540243);(0.5791322,0.3373496)
//        ;(0.6744898,0.3177766);(0.7764218,0.2951257);(0.8871466,0.2691590);(1.0099902,0.2395535)
//        ;(1.1503494,0.2058535);(1.3180109,0.1673756);(1.5341205,0.1229839);(1.86273187,0.07038159)
//      |]
//
